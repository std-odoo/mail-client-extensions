...
export class ProfileCard extends React.Component<ProfileCardProps, {}> {
    ...
    private getIconOrInitials = () => {
        ...
        let iconOrInitials = (
            <img className="icon" src={this.props.icon} onError={this.addDefaultSrc} />
        );
    ...
    render() {
        ...
        const social = (
            <div
                className={`social-links ${
                    nameSize < nameSizeCutoff && !this.props.parentIsCompany
                        ? 'right'
                        : null
                }`}>
                {twitter ? (
                ...
                {crunchbase ? (
                    <a
                        href={'https://crunchbase.com/' + crunchbase}
                        target="_blank"
                        rel="noreferrer noopener">
        ...
        const nameDiv = !this.props.parentIsCompany ? (

        ...
        Office.context.mailbox.item.body.getAsync(
            ...
            async (result) => {
                    ...
                    if (inlineAttachment != null && inlineAttachment.error == undefined) {
                        if (inlineAttachment.oversize) {
                            imageElements[j].setAttribute(
                                'alt',
                                _t(
                                    'Could not display image %(attachmentName)s, size is over limit',
                                    {
                ...
                if (oversizeAttachments.length > 0) {
                    const attachmentNames = oversizeAttachments
                ...
                logContainer = (
                    <div className="log-container">
                        <TooltipHost content={this.props.tooltipContent}>
                            <div
                                className="odoo-secondary-button log-button"
                                onClick={this.logRequest}>

...
class Login extends React.Component<{}, LoginState> {
        ...
        return new Promise((resolve, _) => {
            Office.context.ui.displayDialogAsync(url, options, (asyncResult) => {
                ...
                dialog.addEventHandler(Office.EventType.DialogMessageReceived, (_arg) => {
                    dialog.close();
                    const searchParams = new URL(JSON.parse(_arg['message']).value)
                        .searchParams;
            ...
            <>
                <div className="lower-bounded-tile">
                    <span
                        ...
                        onClick={this.context.navigation.goToMain}>
                        &larr; BACK
                    </span>
                </div>
                ...
                <div className="bounded-tile">
                    ...
                    <DefaultButton
                        className="full-width odoo-clear-button"
                        text="Sign up"
                        onClick={this.signup}
                    />
                    ...
                    <div className="login-info">
                        ...
                        <div>
                            Create Tickets from Emails sent to your personal email
                            address.
                        </div>
                    </div>
                    <div className="login-info">
                    ...
                    <div className="login-info">
                        ...
                        <div>
                            Create Tasks from Emails sent to your personal email address.
                        </div>
                    </div>
                    <div className="login-info">
                        <div className="login-info-icon">
    ...
    _getErrorMessage = () => {
        const ERROR_MESSAGES = {
            ...
            [AuthenticationRequestError.PermissionRefused]:
                'Permission to access your database needs to be granted. ',
            [AuthenticationRequestError.AuthenticationCodeExpired]:
        ...
        if (errorStr) {
            return (
                <span className="error-text">
                    ...
                    See our{' '}
                    <a
                        href="https://www.odoo.com/documentation/master/applications/sales/crm/optimize/outlook_extension.html"
                        target="_blank">
                        FAQ
                    </a>
                    .
    ...
    _getLoggingButton = () => {
        ...
        return (
            <PrimaryButton
                className="form-line full-width odoo-filled-button"
                text="Login"
                onClick={this.login}
            />
        );

...
class Company {
    ...
    static fromJSON(o: Object, enrichmentInfo?: EnrichmentInfo): Company {
        ...
        if (enrichmentInfo != null) {
            if (enrichmentInfo.type == EnrichmentInfoType.NoData) {
                ...
                EnrichmentInfoType.CompanyCreated ||
                EnrichmentInfoType.CompanyUpdated
            ) {
    ...
    getPhone(): string {
        ...
        if (
            this.additionalInfo['phone_numbers'] &&
            this.additionalInfo['phone_numbers'].length > 0
        )
    ...
    getIndustry(): string {
        // TODO 'sector' ?
        const industries = [
            this.additionalInfo['industry_group'],
            this.additionalInfo['sub_industry'],
        ];
